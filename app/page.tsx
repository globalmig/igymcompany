    ...
    <>
      <main className="main-home">
        <div>
          ...
          <div>
            <h3 data-aos="fade-up" data-aos-easing="ease-out" data-aos-duration="1000" data-aos-once="true">
              에스원이벤트와 함께
            </h3>
            <div data-aos="fade-up" data-aos-easing="ease-out" data-aos-duration="1000" data-aos-once="true">
              <h2>행사가 더 즐거워집니다.</h2>
      ...
      <article className="home-event">
        <div>
          <div>
            <h2>PORTFOLIO</h2>
            <p>에스원이벤트은 주관사의 완벽한 행사를 위해 함께 준비해오고 있습니다.</p>
          </div>
          <div>
            <EventList />
            <button>
              <Link href="/event">더보기</Link>
            </button>
          </div>
        </div>
      </article>
        ...
        <div>
          <div>
            <h2>
              에스원이벤트는
              <br />
              파트너쉽을 통한 행사기획,대행 솔루션입니다.
            </h2>
            <p>
              다년간의 행사경험 통해 전문기업으로 성장해 왔습니다. <br className="pc" /> 회사 소개 실적 고객 니즈에 최적화된 행사기획과 운영으로 파트너의 성과 창출을 지원합니다.
              <br className="pc" /> 항상 모든 프로젝트를 성실히 임무수행 하는 ㈜에스원이벤트가 되겠습니다.
            </p>
            <button>
